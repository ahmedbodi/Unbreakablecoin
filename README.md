...
the Unbreakablecoin Core software, see https://www.unbreakablecoin.org/en/download.
...
pull request posted by [UnbreakablecoinPullTester](https://github.com/UnbreakablecoinPullTester). See https://github.com/TheBlueMatt/test-scripts
